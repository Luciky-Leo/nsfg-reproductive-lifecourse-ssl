...
The manuscript is accompanied by source-data tables, figure assets, model metadata, and analysis scripts. Raw individual-level NSFG public-use records are not redistributed; scripts point to CDC/NCHS public-use data portals. The project repository is available at \url{https://github.com/Luciky-Leo/nsfg-reproductive-lifecourse-ssl} and the archived reproducibility package is available at \url{https://doi.org/10.5281/zenodo.20793239}.
